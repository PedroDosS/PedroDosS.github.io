(() => {
  ...
  function makeCreateElementsProxy(namespace) {
    return new Proxy(/* @__PURE__ */ Object.create(null), {
      get(target, tagName, receiver) {
        ...
        function boundCreate(a5, b) {
          const aIsObject = typeof a5 === "object";
          if (a5 === void 0 && b === void 0) {
            return createAndInsertElement(namespace, tagName, null, null);
          } else if (aIsObject && b === void 0) {
            return createAndInsertElement(namespace, tagName, a5, null);
          } else if (b === void 0) {
            return createAndInsertElement(namespace, tagName, null, a5);
          } else if (aIsObject) {
            return createAndInsertElement(namespace, tagName, a5, b);
          } else {
  ...
  // src/pages/about.ts
  var { p: p2, button } = elements;
  function about() {
    p2("Hooray things are working!");
  }

  // src/components/header.ts
  var { a: a2, img: img2, nav } = elements;
  function header2(style) {
  ...
  var { div: div2, p: p3, header: header3, a: a3, section: section2 } = elements;
  function projectCard({ title, description, img: img4, reversed, stack }) {
    div2({
      ...
      section2({}, () => {
        ...
        for (const paragraph of listify(description)) {
          p3({ class: "description" }, paragraph);
        }
        if (stack) {
          addStack(stack);
        }
  ...
  var { img: img3, a: a4, main: main2 } = elements;
  function projects() {
    main2({ class: "project-list" }, () => {
      header2("transform: translate(-3em)");
      projectCard({
        title: "OneSearch",
        description: [
